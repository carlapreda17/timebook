...
const ViewTechnicalPersonsCard = () => {
  return (
    <div className="flex justify-center">
      <div className="rounded-lg shadow-lg bg-white max-w-xs dark:bg-slate-800">
        ...
        <div className="p-6">
          <h5 className="text-gray-900 text-xl font-medium mb-2 dark:text-white">Timesheets</h5>
          <p className="text-gray-700 text-sm mb-4 dark:text-slate-300">
            Vizualizeaza timesheeturile persoanelor tehnice din cadrul companiei.
          </p>
          <Link href={`admin/technical-people`}>
            <a
              type="button"
...
export default ViewTechnicalPersonsCard;
