...
const UserFilter = ({ onChange, value, role = 'user', active = true, isOnLogbook=false,isProjectPage=false }) => {
  ...
  return (
    <div className={`w-fit tablet:w-56 ${isOnLogbook || isProjectPage? 'laptop:w-80' : ''}`}>
      <div>
